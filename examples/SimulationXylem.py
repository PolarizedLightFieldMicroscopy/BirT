...
volume_file_path = r"../reconstructions/Xylem/2026-04-26_05-07-14_Mac_XylemACrop4_2026-04-25-ItDef300_OptInfDef_ItDef500/volume.h5"
...
save_dir = r"../reconstructions/Xylem/2026-04-26_05-07-14_Mac_XylemACrop4_2026-04-25-ItDef300_OptInfDef_ItDef500"
save_as_tif(os.path.join(save_dir, "LFRecon_Ret.tif"),
            simulator.ret_img.detach().cpu().numpy(),
            {"Optical info": optical_info}
            )
save_as_tif(os.path.join(save_dir, "LFRecon_Azim.tif"),
