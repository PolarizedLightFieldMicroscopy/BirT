...
continue_recon = True
recon_init_file_path = os.path.join(r"../reconstructions/Xylem/2026-04-26_17-49-03_Mac_XylemACrop4_XylemACrop4Ss1Rand_OptInfDef_ItNegPen100Def100/volume.h5")
# recon_init_file_path = os.path.join(r"../data/Xylem/Simulation Data/XylemACrop4Ss1Random.h5")

# For loading forward images that were saved in a previous reconstruction folder
measurement_dir = os.path.join(r"../data/Xylem/Experimental Data")
...
if simulate:
    ...
    ret_image_meas_tiff = imread(os.path.join(measurement_dir, "XylemACrop4Float32bitRet.tif"))
    ret_image_meas = np.array(ret_image_meas_tiff)
    azim_image_meas_tiff = imread(os.path.join(measurement_dir, "XylemACrop4Float32bitAzim.tif"))
